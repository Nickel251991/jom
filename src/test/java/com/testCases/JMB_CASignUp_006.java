...
public class JMB_CASignUp_006 extends BaseClass{
  ...
  public void JMB_CASignUp_006() throws IOException {
	...
	//Started the First name  test
		...
		driver.findElement(By.xpath("//input[@id='firstname']")).sendKeys("Nikhil1234567891234567891234567891234567891234567891234");
		...
		System.out.println("Expected message is displayed. SignUp006 passed");
